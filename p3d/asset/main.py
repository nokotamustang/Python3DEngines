...
class MyGame(ShowBase):
    ...
    def setupSkybox(self):
        skybox = loader.loadModel('asset/sky_box/blue.egg')
        skybox.setScale(500)
    ...
    def loadModels(self):
        self.grassBlock = loader.loadModel('asset/block/grass.glb')
        self.dirtBlock = loader.loadModel('asset/block/dirt.glb')
        self.stoneBlock = loader.loadModel('asset/block/stone.glb')
        self.sandBlock = loader.loadModel('asset/block/sand.glb')
